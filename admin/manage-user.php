                        ...
                        <section class="dashboard">
                            <?php if (isset($_SESSION['add-user-success'])) :   // shows if add user was successful?>
                                        ...
                                        <div class="alert-message error container">
                                          ...
                                          <?php elseif (isset($_SESSION['delete-user'])) :   // shows if is not user was not successful?>
                                        <div class="alert-message error container">
                                            <p>
                            ...
                            <div class="container dashboard-container">
                                <button class="sidebar-toggle" id="show-sidebar-btn">
                                    <i class="uil uil-angle-right-b"></i>
                                </button>
                                <button class="sidebar-toggle" id="hide-sidebar-btn">
                                ...
                                <aside>
                                    <ul>
                                        ...
                                        <li><a href="manage-user.php" class="active"><i class="uil uil-users-alt"></i><h5>Manage User</h5></a></li>
